	...
	return [
		...
		>
			...
			<article>
				...
				<section id="arena-resort" class="relative mt-12">
					<div role="presentation" class="absolute z-10 bg-cover h-full w-full opacity-40" style="background-image: url(/bg.1.jpg);"></div>
				...
				<section id="cairo" class="relative mt-12">
					<div role="presentation" class="absolute z-10 bg-cover h-full w-full opacity-40" style="background-image: url(/bg.2.jpg);"></div>
					<div class="relative z-20 p-12 min-h-screen">
				...
				<section id="luxor" class="relative mt-12">
					<div role="presentation" class="absolute z-10 bg-cover h-full w-full opacity-40" style="background-image: url(/bg.3.jpg);"></div>
					<div class="relative z-20 p-12 min-h-screen">
